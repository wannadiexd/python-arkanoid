...
while True:
    ...
    if game_state == 'playing':
        ...
        if ball_status == 'lost':
            ...
            bounce_sound.play()
            # !!! PHASE: VISUAL EFFECTS !!!
            # Generate sparks on collision
            for _ in range(5): # 5 sparks
    ...
    if game_state != 'playing':
        if game_state == 'you_win':
            ...
            if firework_timer <= 0:
                ...
                firework_timer = random.randint(20, 50) # New firework every 0.3-0.8 seconds
